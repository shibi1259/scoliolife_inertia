...
<script type="text/javascript" src="{{asset('vendor/sumantablog-menu/scripts.js')}}"></script>
<script type="text/javascript" src="{{asset('vendor/sumantablog-menu/scripts2.js')}}"></script>
<script type="text/javascript" src="{{asset('vendor/sumantablog-menu/menu.js')}}"></script>